...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2023, Month.OCTOBER, 02), "Evento 4", "Atração 4");
        agendaEventos.adicionarEvento(LocalDate.of(2023, Month.OCTOBER, 03), "Evento 5", "Atração 5");


        agendaEventos.exibirAgenda();

        // Exibindo próximo evento
